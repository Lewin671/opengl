...
// window callback function, set the viewport
void framebuffer_size_callback(GLFWwindow* window, int width, int height);
// mouse callback, capture the mouse event
void mouse_callback(GLFWwindow* window, double xpos, double ypos);
// scrool callback to move the camera
...
int main()
{
	...
	// -------------------------
	Shader shader("vshade.vs", "fshade.fs");
	...
	//    注：
	//      如果你有一个四边形，并且纹理坐标从0到1，纹理将被绘制一次。
	//      如果坐标从0到2并且换行设置为GL_REPEAT ，则纹理将被绘制两次。
	//		参考http://www.ufgame.com/10-2.html
	float planeVertices[] = {
		// positions          // texture Coords 
